 ...
 */
import { CommonSocketConfig, MediaType, SocketConfig } from '../Types';
...
export declare const NOISE_MODE = "Noise_XX_25519_AESGCM_SHA256";
...
export declare const WAILEY_CONFIG: CommonSocketConfig;
export declare const PROCESSABLE_HISTORY_TYPES: Set<string>;
