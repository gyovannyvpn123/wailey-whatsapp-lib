...
class Client extends EventEmitter {
    ...
    async requestPairingCode(phoneNumber) {
        ...
        const isDemoMode = phoneNumber.includes('XXXX');
        
        if (isDemoMode) {
            console.log('DEMO MODE: Using a demonstration pairing code for test number');
            
            // In demo mode, generate a fake code that looks realistic
            const demoCode = '12345678';
